    ...
    <div class="navbar-top-left">
        <div class="brand-logo">
            <a href="{{ route('admin.dashboard.index') }}">
                ...
                {{-- <img
                    src="{{ \Illuminate\Support\Facades\Storage::url(core()->getConfigData('general.design.admin_logo.logo_image', core()->getCurrentChannelCode())) }}"
                    alt="{{ config('app.name') }}" style="height: 40px; width: 110px;" /> --}}
                <img src="http://127.0.0.1:8000/storage/configuration/Hp6BQZ6i6m4Y2TZQ0cEuRAmFQVMlPv909YGMXD6Y.png"
    ...
    <div class="navbar-top-right">
        <div class="profile">
                ...
                <div class="dropdown-list bottom-right">
                    <div class="dropdown-container">
                        <ul>
                            ...
                            <li>
                                <a
                                    href="{{ url()->current() . '?' . http_build_query(array_merge(request()->all(), ['admin_locale' => $code])) }}">
                                    {{ $name }}
                                </a>
                            </li>
                            @endforeach
            ...
            <div class="profile-info">
                ...
                <div class="dropdown-list bottom-right">
                    <span class="app-version">{{ __('admin::app.layouts.app-version', ['version' => 'v' .
                        ...
                        <ul>
                            <li>
                                <a href="{{ route('shop.home.index') }}" target="_blank">{{
                                    __('admin::app.layouts.visit-shop') }}</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.account.edit') }}">{{ __('admin::app.layouts.my-account')
                                    }}</a>
                            </li>
                            <li>
